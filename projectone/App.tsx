...
const CustomTabBar: React.FC<CustomTabBarProps> = ({ state, descriptors, navigation }) => {
  const images = {
    Homescreen: require('C:/Users/paque/AwesomeProject/resources/pngs/casa.png'),
    Likes: require('./resources/pngs/emptyheart.png'),
    Postponed: require('./resources/pngs/reloj.png'),
    SearchPage: require('./resources/pngs/search.png'),
  };
...
const UrlGrabber = ({ elementPackage, elementIndex }) => {
...
const SwipeableImage = ({ elementPackage, onLike, onPostpone, onDislike, elementIndex, onImageOneClick, onImageTwoClick, onImageThreeClick, mainIndex, firstIndex, secondIndex, thirdIndex, AbrirEnGoogle, onFavorite }) => {
...
const LikedPage = ({ likedElements, handleRightArrowPress, favoriteElements, abrirEnGoogle }) => {
