...
import FetchSerials from './modules/data_serials';
import FetchWatchedSerials from './modules/watched_serials';
...
const serialFetcher = () => {
  let serials = FetchSerials();
  console.log(serials)
  let watched_serials = FetchWatchedSerials({id: '0'}).split('.')
  let lista_enteros: number[] = watched_serials.map((item) => parseInt(item, 10));
  console.log(lista_enteros)
  serials = serials.filter((x) => !lista_enteros.includes(x));
  console.log(serials)
...
const HomeScreen = () => {
  console.log('WWWWWWWWWWWWWWWwWeWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW', serialFetcher())
